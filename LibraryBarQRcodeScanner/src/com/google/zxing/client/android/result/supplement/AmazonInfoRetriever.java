...
final class AmazonInfoRetriever extends SupplementalInfoRetriever {
	...
	AmazonInfoRetriever(TextView textView, String type, String productID, HistoryManager historyManager, Context context) {
	...
	private boolean doRetrieveForCountry(String theCountry) throws IOException {
		...
		CharSequence contents = HttpHelper.downloadViaHttp("https://bsplus.srowen.com/ss?c=" + theCountry + "&t=" + type + "&i=" + productID,
