 ...
 * 
 * <p>
 * <strong>Please do not reuse this code.</strong> Using results in this way requires permission from Google, and that is not granted to users via
 * this project.
 * </p>
 * 
 * @author Sean Owen
...
final class ProductResultInfoRetriever extends SupplementalInfoRetriever {
	...
	private static final Pattern[] PRODUCT_NAME_PRICE_PATTERNS = { Pattern.compile(",event\\)\">([^<]+)</a></h3>.+<span class=psrp>([^<]+)</span>"),
