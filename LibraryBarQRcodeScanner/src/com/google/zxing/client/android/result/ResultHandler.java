...
/**
 * A base class for the Android-specific barcode handlers. These allow the app to polymorphically suggest the appropriate actions for each data type.
 * 
 * This class also contains a bunch of utility methods to take common actions like opening a URL. They could easily be moved into a helper object, but
 * it can't be static because the Activity instance is needed to launch an intent.
 * 
...
public abstract class ResultHandler {
	...
	final void addContact(String[] names, String[] nicknames, String pronunciation, String[] phoneNumbers, String[] phoneTypes, String[] emails,
			String[] emailTypes, String note, String instantMessenger, String address, String addressType, String org, String title, String[] urls,
			String birthday, String[] geo) {
